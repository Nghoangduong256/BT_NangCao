package BaiTapOOP.ChuaBai.CapDo2_TrungBinh.Bai3;
...
public class Main {
    public static void main(String[] args) {
        ...
        //Khởi tạo CartItem
        CartItem ps5Items = new CartItem(ps5, 1);
        CartItem laptopAcerItems = new CartItem(laptopAcer, 2);
        CartItem manHinhPCItems = new CartItem(manHinhPC, 1);

        //Đưa hàng vào Cart
        Cart cart = new Cart();
        cart.add_product(ps5Items);
        cart.add_product(laptopAcerItems);
        cart.add_product(manHinhPCItems);
